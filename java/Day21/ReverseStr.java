...
//      01234
	 ...
	 */
	public static String revStr(String str) {     //เปิดวีดีโอดูย้อนหลังอีกทีนึงนะ ยังไม่แม่น ไม่เข้าใจ
		//String rev = "";
		//for (int i = str.length() - 1; i >= 0; i--) {
		//	char ch = str.charAt(i);   // rev += str.charAt(i)
		//	rev = rev + ch;
		//}
		
		//return rev;
		
		//ทำได้อีกแบบนึง อันนี้แอดวานซ์ กว่า

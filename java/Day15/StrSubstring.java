...
public class StrSubstring {
	...
	public static void main(String[] args) {
		...
		//The positions are represent as indexes
		//Index starts form 0
		
		
		//             0123456789
		String java = "Java is fun but sometime hard.";
		...
		System.out.println(java); // Java is fun but sometime hard.
		
		
		//   = is fun but sometime hard.
		java = java.substring(5); // อันนี้กำหนดค่าใหม่โดยไม่ต้องกำหนด data type เพราะว่ามันมีอยู่แล้วคือ String java
		System.out.println(java); // is fun but sometime hard.
		...
		System.out.println("str3 : "+ str3); // str3 : work
		 //           012345678910
		String tla = "Tech lead Acdemy";
		System.out.println(tla.substring(5,9)); // lead

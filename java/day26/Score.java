...
public class Score {
	...
	public static void main(String[] args) {
		...
		//  0    1    2    3    4     index เริ่มนับตั้งแต่ 0
		//{[80] [70] [50] [90] [60]}
		int [] score = new int[5]; //<-- กำหนด จำนวน แน่นอน
		score[0] = 80;
		score[1] = 70;
		score[2] = 50;
		score[3] = 90;
		...
		//score[5] = 100; //ArrayIndexOutOfBoundException  นอกเหนือจากจำนวนที่กำหนดไว้จะเป็นแบบนี้

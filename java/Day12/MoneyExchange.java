...
public class MoneyExchange {
	...
	public static void main(String[] args) {
		...
		ruble = 250; // 0.014 * 250 = 3.5
		System.out.println(exchangeRuble(ruble));
		
		//final String name = "John Doe"; ตัวอย่าง คำว่า final  คือไม่สามารถเปลี่ยนได้
		// ในอันนี้ชื่อ john doe ไม่สามารถเปลี่ยนเป็น will smith ได้

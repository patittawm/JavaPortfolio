...
public class WarmUp3FillUpIndex {
	...
	public static void main(String[] args) {
		...
		System.out.println("Array two :" + Arrays.toString(arrayTwo)); // Array two :[Six, Seven, Eight, Nine]

		// TODO
		// We have two array. Can you create another array that will hold values of
		// above two arrays?

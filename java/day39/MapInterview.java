...
public class MapInterview {
	 ...
	 * getLetterCount("aaarrroooo"); -> {a=3, r=3, o=4} getLetterCount("apple"); ->
	 * {a=1, p=2, l=1, e=1}
	 */
	...
	public static String getStrLetterCount(String str) { // เปลี่ยนเปน สตริง ตอนหลัง
		Map<Character, Integer> map = new LinkedHashMap<>();
		...
		// หลังจากด้านบนต้องเปลี่ยนเป็น string 
		String res = "";

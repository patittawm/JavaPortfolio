...
public class SortingTasks { // Interview Question
	 ...
	 */
	public static int maxN(int[] arr, int n) {   // คิดไม่ออกอันนี้ ทบทวนดีๆ ไม่เข้าหัวเลย
		if(n > arr.length || n < 1) {
			return 0;
		}
		Arrays.sort(arr);	
	...
	/*
	 * isAnagram("abc", "bca"); -> true isAnagram("triangle", "integral"); -> true
	 * isAnagram("hello", "heelo"); -> false isAnagram("aaa", "a"); -> false
	 * isAnagram("a", "aa"); -> false
	 * 
	 * 1. sort both strings 2. compare them
	 */
